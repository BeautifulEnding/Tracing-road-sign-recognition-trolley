...
architecture behav of hls_line is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "hls_line,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7s15ftgb196-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=11.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=1754,HLS_SYN_LUT=2734,HLS_VERSION=2018_2}";
    ...
    signal Block_Mat_exit5_proc_U0_img_01_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit5_proc_U0_img_01_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit5_proc_U0_img_01_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit5_proc_U0_img_01_cols_V_out_write : STD_LOGIC;
    ...
    signal gray2bin_U0_ap_start : STD_LOGIC;
    signal gray2bin_U0_ap_done : STD_LOGIC;
    signal gray2bin_U0_ap_continue : STD_LOGIC;
    signal gray2bin_U0_ap_idle : STD_LOGIC;
    signal gray2bin_U0_ap_ready : STD_LOGIC;
    signal gray2bin_U0_p_src_data_stream_V_read : STD_LOGIC;
    signal gray2bin_U0_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_channel_done_output : STD_LOGIC;
    signal output_full_n : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_ap_start : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_ap_done : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_ap_continue : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_ap_idle : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_channel_done_output_load_loc_chan : STD_LOGIC;
    signal output_load_loc_chan_full_n : STD_LOGIC;
    signal p_line_stream_line_c_U0_ap_start : STD_LOGIC;
    signal p_line_stream_line_c_U0_ap_done : STD_LOGIC;
    signal p_line_stream_line_c_U0_ap_continue : STD_LOGIC;
    signal p_line_stream_line_c_U0_ap_idle : STD_LOGIC;
    signal p_line_stream_line_c_U0_ap_ready : STD_LOGIC;
    signal p_line_stream_line_c_U0_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_p_line_stream_line_c_fu_296_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal img_01_rows_V_c14_full_n : STD_LOGIC;
    signal img_01_rows_V_c14_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal img_01_rows_V_c14_empty_n : STD_LOGIC;
    signal img_01_cols_V_c15_full_n : STD_LOGIC;
    signal img_01_cols_V_c15_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal img_01_cols_V_c15_empty_n : STD_LOGIC;
    ...
    signal output_load_loc_chan_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal output_load_loc_chan_empty_n : STD_LOGIC;
    ...
    signal start_for_gray2bin_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_gray2bin_U0_full_n : STD_LOGIC;
    signal start_for_gray2bin_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_gray2bin_U0_empty_n : STD_LOGIC;
    signal gray2bin_U0_start_full_n : STD_LOGIC;
    signal gray2bin_U0_start_write : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_start_full_n : STD_LOGIC;
    signal Block_Mat_exit59_pro_U0_start_write : STD_LOGIC;
    signal p_line_stream_line_c_U0_start_full_n : STD_LOGIC;
    signal p_line_stream_line_c_U0_start_write : STD_LOGIC;
    ...
    component Block_Mat_exit59_pro IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component p_line_stream_line_c IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component start_for_gray2big8j IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    gray2bin_U0 : component gray2bin
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Block_Mat_exit59_pro_U0 : component Block_Mat_exit59_pro
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    p_line_stream_line_c_U0 : component p_line_stream_line_c
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    img_01_rows_V_c14_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_01_cols_V_c15_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    output_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    output_load_loc_chan_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_gray2big8j_U : component start_for_gray2big8j
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = Block_Mat_exit5_proc_U0_ap_ready))) then 
                Block_Mat_exit5_proc_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit5_proc_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_Mat_exit59_pro_U0_ap_continue <= output_load_loc_chan_full_n;
    Block_Mat_exit59_pro_U0_ap_start <= output_empty_n;
    Block_Mat_exit59_pro_U0_start_full_n <= ap_const_logic_1;
    Block_Mat_exit59_pro_U0_start_write <= ap_const_logic_0;
    ...
    ap_channel_done_output <= gray2bin_U0_ap_done;
    ap_channel_done_output_load_loc_chan <= Block_Mat_exit59_pro_U0_ap_done;
    ap_done <= p_line_stream_line_c_U0_ap_done;
    ap_idle <= (p_line_stream_line_c_U0_ap_idle and gray2bin_U0_ap_idle and (output_load_loc_chan_empty_n xor ap_const_logic_1) and (output_empty_n xor ap_const_logic_1) and CvtColor_U0_ap_idle and Block_Mat_exit5_proc_U0_ap_idle and Block_Mat_exit59_pro_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ...
    ap_sync_done <= p_line_stream_line_c_U0_ap_done;
    ap_sync_ready <= (ap_sync_Block_Mat_exit5_proc_U0_ap_ready and ap_sync_AXIvideo2Mat_U0_ap_ready);
    gray2bin_U0_ap_continue <= output_full_n;
    gray2bin_U0_ap_start <= start_for_gray2bin_U0_empty_n;
    gray2bin_U0_start_full_n <= ap_const_logic_1;
    gray2bin_U0_start_write <= ap_const_logic_0;
    p_line_stream_line_c_U0_ap_continue <= ap_const_logic_1;
    p_line_stream_line_c_U0_ap_start <= output_load_loc_chan_empty_n;
    p_line_stream_line_c_U0_start_full_n <= ap_const_logic_1;
    p_line_stream_line_c_U0_start_write <= ap_const_logic_0;
    src_axi_TREADY <= AXIvideo2Mat_U0_src_axi_TREADY;
    start_for_CvtColor_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_gray2bin_U0_din <= (0=>ap_const_logic_1, others=>'-');
    tmp_p_line_stream_line_c_fu_296_ap_return <= ap_const_lv32_0;
end behav;
