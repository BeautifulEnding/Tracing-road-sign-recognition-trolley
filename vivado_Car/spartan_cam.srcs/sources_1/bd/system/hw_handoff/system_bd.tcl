...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set FPGA_AR_OE1 [ create_bd_port -dir O -from 0 -to 0 FPGA_AR_OE1 ]
  set FPGA_DONE [ create_bd_port -dir O -from 0 -to 0 FPGA_DONE ]
  ...
  # Create instance: detect_0, and set properties
  set detect_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:detect:1.0 detect_0 ]

  # Create instance: hls_line_0, and set properties
  set hls_line_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:hls_line:1.0 hls_line_0 ]

  # Create instance: lite_0, and set properties
  set lite_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:lite:1.0 lite_0 ]

  # Create instance: lite_2, and set properties
  set lite_2 [ create_bd_cell -type ip -vlnv xilinx.com:hls:lite:1.0 lite_2 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins lite_0/s_axi_AXILiteS] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins lite_2/s_axi_AXILiteS] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  ...
  connect_bd_intf_net -intf_net v_vid_in_axi4s_0_video_out [get_bd_intf_pins hls_line_0/src_axi] [get_bd_intf_pins v_vid_in_axi4s_0/video_out]
  connect_bd_intf_net -intf_net v_vid_in_axi4s_1_video_out [get_bd_intf_pins detect_0/src_axi] [get_bd_intf_pins v_vid_in_axi4s_1/video_out]

  # Create port connections
  connect_bd_net -net PID_0_ConMsg [get_bd_pins PID_0/ConMsg] [get_bd_pins lite_0/input_r]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets PID_0_ConMsg]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports UART_0_txd] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net bayer2rgb_0_data_out [get_bd_pins bayer2rgb_0/data_out] [get_bd_pins rgb2dvi_0/vid_pData] [get_bd_pins v_vid_in_axi4s_0/vid_data] [get_bd_pins v_vid_in_axi4s_1/vid_data]
  connect_bd_net -net bayer2rgb_0_de_out [get_bd_pins bayer2rgb_0/de_out] [get_bd_pins rgb2dvi_0/vid_pVDE] [get_bd_pins v_vid_in_axi4s_0/vid_active_video] [get_bd_pins v_vid_in_axi4s_1/vid_active_video]
  connect_bd_net -net bayer2rgb_0_hsync_out [get_bd_pins bayer2rgb_0/hsync_out] [get_bd_pins rgb2dvi_0/vid_pHSync] [get_bd_pins v_vid_in_axi4s_0/vid_hsync] [get_bd_pins v_vid_in_axi4s_1/vid_hsync]
  connect_bd_net -net bayer2rgb_0_vsync_out [get_bd_pins bayer2rgb_0/vsync_out] [get_bd_pins rgb2dvi_0/vid_pVSync] [get_bd_pins v_vid_in_axi4s_0/vid_vsync] [get_bd_pins v_vid_in_axi4s_1/vid_vsync]
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins bayer2rgb_0/clk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins csi2dvp_0/vid_clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk] [get_bd_pins v_vid_in_axi4s_1/vid_io_in_clk]
  ...
  connect_bd_net -net detect_0_ap_return [get_bd_pins detect_0/ap_return] [get_bd_pins lite_2/input_r]
  connect_bd_net -net hls_line_0_ap_return [get_bd_pins PID_0/LineLocation] [get_bd_pins hls_line_0/ap_return]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_200M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins PID_0/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins csi2_d_phy_rx_0/in_delay_clk] [get_bd_pins detect_0/ap_clk] [get_bd_pins hls_line_0/ap_clk] [get_bd_pins lite_0/ap_clk] [get_bd_pins lite_2/ap_clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_200M/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins v_vid_in_axi4s_1/aclk]
  ...
  connect_bd_net -net rst_clk_wiz_0_200M_peripheral_aresetn [get_bd_pins PID_0/rst] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins detect_0/ap_rst_n] [get_bd_pins hls_line_0/ap_rst_n] [get_bd_pins lite_0/ap_rst_n] [get_bd_pins lite_2/ap_rst_n] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_200M/peripheral_aresetn]
  connect_bd_net -net rx_0_1 [get_bd_ports UART_0_rxd] [get_bd_pins axi_uartlite_0/rx]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports cam_gpio] [get_bd_pins csi_to_axis_0/enable_in] [get_bd_pins csi_to_axis_0/m_axis_aresetn] [get_bd_pins detect_0/ap_start] [get_bd_pins hls_line_0/ap_start] [get_bd_pins lite_0/input_r_ap_vld] [get_bd_pins lite_2/input_r_ap_vld] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_1/aresetn] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_ports FPGA_AR_OE1] [get_bd_ports FPGA_DONE] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins detect_0/cols] [get_bd_pins hls_line_0/cols] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins detect_0/rows] [get_bd_pins hls_line_0/rows] [get_bd_pins xlconstant_3/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs lite_0/s_axi_AXILiteS/Reg] SEG_lite_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs lite_2/s_axi_AXILiteS/Reg] SEG_lite_2_Reg
