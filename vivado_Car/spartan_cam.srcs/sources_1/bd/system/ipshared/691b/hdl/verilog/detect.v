...
(* CORE_GENERATION_INFO="detect,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7s15ftgb196-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=11.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=873,HLS_SYN_LUT=2049,HLS_VERSION=2018_2}" *)
...
wire   [31:0] Block_Mat_exit6_proc_U0_img_01_rows_V_out_din;
wire    Block_Mat_exit6_proc_U0_img_01_rows_V_out_write;
wire   [31:0] Block_Mat_exit6_proc_U0_img_01_cols_V_out_din;
wire    Block_Mat_exit6_proc_U0_img_01_cols_V_out_write;
...
wire    segment_U0_ap_done;
wire    segment_U0_ap_continue;
wire    segment_U0_ap_idle;
wire    segment_U0_ap_ready;
wire    segment_U0_p_src_data_stream_V_read;
wire   [30:0] segment_U0_ap_return;
wire    ap_channel_done_output;
wire    output_full_n;
wire    Block_Mat_exit610_pr_U0_ap_start;
wire    Block_Mat_exit610_pr_U0_ap_done;
wire    Block_Mat_exit610_pr_U0_ap_continue;
wire    Block_Mat_exit610_pr_U0_ap_idle;
...
wire    p_detectRoadSign_det_U0_ap_start;
wire    p_detectRoadSign_det_U0_ap_done;
wire    p_detectRoadSign_det_U0_ap_continue;
wire    p_detectRoadSign_det_U0_ap_idle;
wire    p_detectRoadSign_det_U0_ap_ready;
wire   [30:0] p_detectRoadSign_det_U0_ap_return;
wire   [31:0] p_trunc_ext_fu_302_p1;
...
wire   [30:0] output_dout;
wire    output_empty_n;
wire   [30:0] extLd_loc_channel_dout;
...
wire   [0:0] start_for_segment_U0_din;
wire    start_for_segment_U0_full_n;
wire   [0:0] start_for_segment_U0_dout;
wire    start_for_segment_U0_empty_n;
wire    segment_U0_start_full_n;
wire    segment_U0_start_write;
wire    Block_Mat_exit610_pr_U0_start_full_n;
wire    Block_Mat_exit610_pr_U0_start_write;
wire    p_detectRoadSign_det_U0_start_full_n;
wire    p_detectRoadSign_det_U0_start_write;
...
Block_Mat_exit610_pr Block_Mat_exit610_pr_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
p_detectRoadSign_det p_detectRoadSign_det_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
fifo_w32_d2_A img_01_rows_V_c15_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A img_01_cols_V_c16_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w31_d2_A extLd_loc_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_segmentfYi start_for_segmentfYi_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    ...
    end else if (((ap_sync_ready == 1'b0) & (1'b1 == Block_Mat_exit6_proc_U0_ap_ready))) begin
        Block_Mat_exit6_proc_U0_ap_ready_count <= (Block_Mat_exit6_proc_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit610_pr_U0_ap_continue = extLd_loc_channel_full_n;

assign Block_Mat_exit610_pr_U0_ap_start = output_empty_n;

assign Block_Mat_exit610_pr_U0_start_full_n = 1'b1;

assign Block_Mat_exit610_pr_U0_start_write = 1'b0;
...
assign ap_channel_done_extLd_loc_channel = Block_Mat_exit610_pr_U0_ap_done;

assign ap_channel_done_output = segment_U0_ap_done;

assign ap_done = p_detectRoadSign_det_U0_ap_done;

assign ap_idle = (segment_U0_ap_idle & p_detectRoadSign_det_U0_ap_idle & (extLd_loc_channel_empty_n ^ 1'b1) & (output_empty_n ^ 1'b1) & CvtColor_U0_ap_idle & Block_Mat_exit6_proc_U0_ap_idle & Block_Mat_exit610_pr_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_return = p_detectRoadSign_det_U0_ap_return;
...
assign ap_sync_done = p_detectRoadSign_det_U0_ap_done;

assign ap_sync_ready = (ap_sync_Block_Mat_exit6_proc_U0_ap_ready & ap_sync_AXIvideo2Mat_U0_ap_ready);

assign p_detectRoadSign_det_U0_ap_continue = 1'b1;

assign p_detectRoadSign_det_U0_ap_start = extLd_loc_channel_empty_n;

assign p_detectRoadSign_det_U0_start_full_n = 1'b1;

assign p_detectRoadSign_det_U0_start_write = 1'b0;

assign p_trunc_ext_fu_302_p1 = 32'd0;

assign segment_U0_ap_continue = output_full_n;

assign segment_U0_ap_start = start_for_segment_U0_empty_n;

assign segment_U0_start_full_n = 1'b1;

assign segment_U0_start_write = 1'b0;

assign src_axi_TREADY = AXIvideo2Mat_U0_src_axi_TREADY;

assign start_for_CvtColor_U0_din = 1'b1;

assign start_for_segment_U0_din = 1'b1;
